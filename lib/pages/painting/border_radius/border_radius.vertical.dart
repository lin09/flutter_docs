...
class BorderRadiusVerticalScreen extends ConsumerWidget {
  const BorderRadiusVerticalScreen({super.key});

  static const routeName = 'painting/BorderRadius.vertical';
  static const title = 'BorderRadius.vertical';
