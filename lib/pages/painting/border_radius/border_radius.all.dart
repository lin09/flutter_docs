...
class BorderRadiusAllScreen extends ConsumerWidget {
  const BorderRadiusAllScreen({super.key});

  static const routeName = 'painting/BorderRadius.all';
  static const title = 'BorderRadius.all';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: CupertinoColors.activeBlue,
          borderRadius: BorderRadius.all(state.radius),
        ),
      ),
    );
  }
