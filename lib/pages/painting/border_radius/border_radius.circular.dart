...
class BorderRadiusCircularScreen extends ConsumerWidget {
  const BorderRadiusCircularScreen({super.key});

  static const routeName = 'painting/BorderRadius.circular';
  static const title = 'BorderRadius.circular';
