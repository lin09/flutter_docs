...
class PreviousFocusActionScreen extends ConsumerWidget {
  const PreviousFocusActionScreen({super.key});

  static const routeName = 'widgets/PreviousFocusAction';
  static const title = 'PreviousFocusAction';
