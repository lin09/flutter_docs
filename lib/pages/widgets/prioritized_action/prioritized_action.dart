...
class PrioritizedActionScreen extends ConsumerWidget {
  const PrioritizedActionScreen({super.key});

  static const routeName = 'widgets/PrioritizedAction';
  static const title = 'PrioritizedAction';
