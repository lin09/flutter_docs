...
class SingleChildRenderObjectWidgetScreen extends ConsumerWidget {
  const SingleChildRenderObjectWidgetScreen({super.key});

  static const routeName = 'widgets/SingleChildRenderObjectWidget';
  static const title = 'SingleChildRenderObjectWidget';
