...
class DefaultTextStyleTransitionScreen extends ConsumerWidget {
  const DefaultTextStyleTransitionScreen({super.key});

  static const routeName = 'widgets/DefaultTextStyleTransition';
  static const title = 'DefaultTextStyleTransition';
