...
class ChildBackButtonDispatcherScreen extends ConsumerWidget {
  const ChildBackButtonDispatcherScreen({super.key});

  static const routeName = 'widgets/ChildBackButtonDispatcher';
  static const title = 'ChildBackButtonDispatcher';
