...
class ScrollActionScreen extends ConsumerWidget {
  const ScrollActionScreen({super.key});

  static const routeName = 'widgets/ScrollAction';
  static const title = 'ScrollAction';
