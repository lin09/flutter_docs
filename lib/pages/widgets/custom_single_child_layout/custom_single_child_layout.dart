...
class CustomSingleChildLayoutScreen extends ConsumerWidget {
  const CustomSingleChildLayoutScreen({super.key});

  static const routeName = 'widgets/CustomSingleChildLayout';
  static const title = 'CustomSingleChildLayout';
