...
class VoidCallbackActionScreen extends ConsumerWidget {
  const VoidCallbackActionScreen({super.key});

  static const routeName = 'widgets/VoidCallbackAction';
  static const title = 'VoidCallbackAction';
