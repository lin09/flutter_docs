...
class ImplicitlyAnimatedWidgetScreen extends ConsumerWidget {
  const ImplicitlyAnimatedWidgetScreen({super.key});

  static const routeName = 'widgets/ImplicitlyAnimatedWidget';
  static const title = 'ImplicitlyAnimatedWidget';
