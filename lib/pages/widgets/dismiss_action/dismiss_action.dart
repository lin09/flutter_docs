...
class DismissActionScreen extends ConsumerWidget {
  const DismissActionScreen({super.key});

  static const routeName = 'widgets/DismissAction';
  static const title = 'DismissAction';
