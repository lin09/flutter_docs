...
class GlowingOverscrollIndicatorScreen extends ConsumerWidget {
  const GlowingOverscrollIndicatorScreen({super.key});

  static const routeName = 'widgets/GlowingOverscrollIndicator';
  static const title = 'GlowingOverscrollIndicator';
