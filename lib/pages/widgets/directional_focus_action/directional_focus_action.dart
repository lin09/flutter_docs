...
class DirectionalFocusActionScreen extends ConsumerWidget {
  const DirectionalFocusActionScreen({super.key});

  static const routeName = 'widgets/DirectionalFocusAction';
  static const title = 'DirectionalFocusAction';
