...
class RootBackButtonDispatcherScreen extends ConsumerWidget {
  const RootBackButtonDispatcherScreen({super.key});

  static const routeName = 'widgets/RootBackButtonDispatcher';
  static const title = 'RootBackButtonDispatcher';
