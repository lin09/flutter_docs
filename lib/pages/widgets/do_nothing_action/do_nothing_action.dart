...
class DoNothingActionScreen extends ConsumerWidget {
  const DoNothingActionScreen({super.key});

  static const routeName = 'widgets/DoNothingAction';
  static const title = 'DoNothingAction';
