...
class DecoratedBoxTransitionScreen extends ConsumerWidget {
  const DecoratedBoxTransitionScreen({super.key});

  static const routeName = 'widgets/DecoratedBoxTransition';
  static const title = 'DecoratedBoxTransition';
