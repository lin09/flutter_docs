...
class NextFocusActionScreen extends ConsumerWidget {
  const NextFocusActionScreen({super.key});

  static const routeName = 'widgets/NextFocusAction';
  static const title = 'NextFocusAction';
